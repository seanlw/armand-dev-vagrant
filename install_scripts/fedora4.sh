...
mkdir -p /var/armand/fedora
chown tomcat7:tomcat7 /var/armand/fedora
...
echo "JAVA_OPTS=\"\${JAVA_OPTS} -Dfcrepo.modeshape.configuration=classpath:/config/file-simple/repository.json -Dfcrepo.home=/var/armand/fedora/\"" >> /etc/default/tomcat7
